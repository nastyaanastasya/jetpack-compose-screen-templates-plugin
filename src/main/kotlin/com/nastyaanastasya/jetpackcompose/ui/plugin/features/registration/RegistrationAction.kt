...
import com.nastyaanastasya.jetpackcompose.ui.plugin.features.registration.injection.RegistrationViewModelFactory

class RegistrationAction : AnAction() {

    override fun actionPerformed(e: AnActionEvent) {
        val dependencies = ProjectDependencies(e.project)
        val directory = e.getData(CommonDataKeys.PSI_ELEMENT) as PsiDirectory
        val viewModel = RegistrationViewModelFactory.create(directory, dependencies)
        RegistrationDialog(viewModel).show()
    }
}